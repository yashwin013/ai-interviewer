      ...
      <div className="w-full max-w-md bg-[#1a1633]/80 backdrop-blur-xl rounded-2xl shadow-2xl p-8 border border-[rgba(0,217,255,0.15)] z-10 animate-scale-in">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="animate-slide-up" style={{animationDelay: '0.1s'}}>
            ...
            <div className="relative group">
              <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                <svg className="h-5 w-5 text-white/40 group-focus-within:text-purple-400 transition" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-3.5 bg-white/10 border border-white/20 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:border-purple-400 transition text-white placeholder-white/40 input-focus backdrop-blur-sm"
                value={email}
          ...
          <div className="animate-slide-up" style={{animationDelay: '0.2s'}}>
            ...
            <div className="relative group">
              ...
              <input
                ...
                className="w-full pl-12 pr-12 py-3.5 bg-white/10 border border-white/20 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:border-purple-400 transition text-white placeholder-white/40 input-focus backdrop-blur-sm"
              />
              <button
                type="button"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-gradient-to-r from-purple-600 to-blue-600 text-white py-3.5 rounded-xl font-bold text-lg hover:from-purple-700 hover:to-blue-700 transition shadow-lg hover:shadow-xl hover:shadow-purple-500/50 disabled:opacity-50 transform hover:scale-[1.02] active:scale-[0.98] btn-ripple animate-slide-up"
        ...
        <div className="text-center mt-6 animate-slide-up" style={{animationDelay: '0.4s'}}>
          <p className="text-white/70 text-sm">
            ...
            <button
              ...
              className="ml-2 text-purple-300 font-semibold hover:text-purple-200 transition hover:underline"
            >
              Sign up
            </button>
          </p>
